{
 "cells": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 82,
   "id": "cb9d24f5-2b03-4bae-82eb-e25522c4092a",
   "metadata": {},
   "outputs": [
    {
     "name": "stdout",
  ...
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "0ce2638b-1d7a-4a4b-9f2b-33e194c82447",
   "metadata": {},
   "outputs": [],
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 172,
   "id": "c8a35a7c-e588-4518-8277-893d20cb55fb",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  {
   "cell_type": "markdown",
   "id": "5431ca86-f199-4db8-9953-80de64f7e223",
   "metadata": {},
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 1,
   "id": "c58c76ff-e48e-4c68-b589-33c240db3ca6",
   "metadata": {},
   "outputs": [
    {
     "name": "stdout",
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 3,
   "id": "c68f4b06-a7e3-4378-8133-d544c76b4097",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 5,
   "id": "39632a32-2ba6-4d10-b085-c2c7f65b006f",
   "metadata": {},
   "outputs": [],
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 6,
   "id": "0c98612f-add6-43f8-b01e-56790bfa6d53",
   "metadata": {},
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       ...
       "iso_code                                                                       \n",
       "AFG       2020-06-01  Afghanistan        15205           257          390.59   \n",
       "ALB       2020-06-01      Albania         1137            33          395.09   \n",
       "DZA       2020-06-01      Algeria         9394           653          214.22   \n",
       "AND       2020-06-01      Andorra          764            51        9,888.05   \n",
       "AGO       2020-06-01       Angola           86             4            2.62   \n",
       "\n",
       "          total_deaths_pm    population  pop_density  median_age  \\\n",
       "iso_code                                                           \n",
       "AFG                  6.60 38,928,341.00        54.42       18.60   \n",
       "ALB                 11.47  2,877,800.00       104.87       38.00   \n",
       "DZA                 14.89 43,851,043.00        17.35       29.10   \n",
       "AND                660.07     77,265.00       163.75         NaN   \n",
       "AGO                  0.12 32,866,268.00        23.89       16.80   \n",
       "\n",
       "          gdp_per_capita  hosp_beds  \n",
       "iso_code                             \n",
       "AFG             1,803.99       0.50  \n",
  ...
  {
   "cell_type": "markdown",
   "id": "dea5a865-efa0-41f7-87be-4f5994d0631a",
   "metadata": {},
   "source": [
    "### 결측치 처리\n",
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 8,
   "id": "77107084-e4e6-4109-a93d-2a42e94507a6",
   "metadata": {},
   "outputs": [],
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 9,
   "id": "7038bfd0-21d6-43c0-9094-ae821bfb4653",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 11,
   "id": "d7993ef9-d3e7-4d49-a3e0-5a93343b1a07",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 16,
   "id": "6090a021-db9f-4c23-8203-4f5b74e03a6a",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  {
   "cell_type": "markdown",
   "id": "ffc7bf2d-e5c5-48b7-82dd-3755a71b62fa",
   "metadata": {},
   "source": [
    "### 미션 1. \n",
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 26,
   "id": "217f5bca-34fe-45f3-bdd4-07b95f9720ca",
   "metadata": {},
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       ...
       "population     77,265.00 15,002.00                        26,221.00   \n",
       "pop_density       163.75       NaN                              NaN   \n",
       "median_age           NaN       NaN                              NaN   \n",
       "gdp_per_capita       NaN       NaN                              NaN   \n",
       "hosp_beds            NaN       NaN                              NaN   \n",
       "\n",
       "iso_code                           VGB             FRO               FLK  \\\n",
       "location        British Virgin Islands  Faeroe Islands  Falkland Islands   \n",
       "population                   30,237.00       48,865.00          3,483.00   \n",
       "pop_density                     207.97           35.31               NaN   \n",
       "median_age                         NaN             NaN               NaN   \n",
       "gdp_per_capita                     NaN             NaN               NaN   \n",
       "hosp_beds                          NaN             NaN               NaN   \n",
       "\n",
       "iso_code              GIB        GRL       GGY          IMN        JEY  \\\n",
       "location        Gibraltar  Greenland  Guernsey  Isle of Man     Jersey   \n",
       "population      33,691.00  56,772.00 67,052.00    85,032.00 101,073.00   \n",
       "pop_density      3,457.10       0.14       NaN       147.87        NaN   \n",
       "median_age            NaN        NaN       NaN          NaN        NaN   \n",
       "gdp_per_capita        NaN        NaN       NaN          NaN        NaN   \n",
       "hosp_beds             NaN        NaN       NaN          NaN        NaN   \n",
       "\n",
       "iso_code                XKX         MSR                       MNP  \\\n",
       "location             Kosovo  Montserrat  Northern Mariana Islands   \n",
       "population     1,932,774.00    4,999.00                 57,557.00   \n",
       "pop_density             NaN         NaN                    119.88   \n",
       "median_age              NaN         NaN                       NaN   \n",
       "gdp_per_capita          NaN         NaN                       NaN   \n",
       "hosp_beds               NaN         NaN                       NaN   \n",
       "\n",
       "iso_code                 TWN                       TCA      VAT  \\\n",
       "location              Taiwan  Turks and Caicos Islands  Vatican   \n",
       "population     23,816,775.00                 38,718.00   809.00   \n",
       "pop_density              NaN                     37.31      NaN   \n",
       "median_age             42.20                       NaN      NaN   \n",
       "gdp_per_capita           NaN                       NaN      NaN   \n",
       "hosp_beds                NaN                       NaN      NaN   \n",
       "\n",
       "iso_code                   ESH  \n",
       "location        Western Sahara  \n",
       "population          597,330.00  \n",
       "pop_density                NaN  \n",
       "median_age               28.40  \n",
       "gdp_per_capita             NaN  \n",
       "hosp_beds                  NaN  "
  ...
  {
   "cell_type": "markdown",
   "id": "4a52fd30-1f07-413c-a7f2-4860b6f34287",
   "metadata": {},
   "source": [
    "## Index Allignment\n",
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 31,
   "id": "471e63ed-a85b-4767-a4e6-203b87661ae4",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  {
   "cell_type": "markdown",
   "id": "f631af00-066b-433b-a38b-b6e7448d6944",
   "metadata": {},
   "source": [
    "### 코로나 관련 변수만 추출\n",
    "- 결측값이 있는지 확인\n",
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 37,
   "id": "c6a50abe-76d4-4418-abaa-37161c8ce12b",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 41,
   "id": "993cf40a-a07f-4383-9f00-a38a00f93ba2",
   "metadata": {},
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       ...
       "iso_code                                                           \n",
       "AFG       Afghanistan        15205           257          390.59   \n",
       "ALB           Albania         1137            33          395.09   \n",
       "DZA           Algeria         9394           653          214.22   \n",
       "AND           Andorra          764            51        9,888.05   \n",
       "AGO            Angola           86             4            2.62   \n",
       "\n",
       "          total_deaths_pm total_cases_q total_deaths_q  \n",
       "iso_code                                                \n",
       "AFG                  6.60            높음             높음  \n",
       "ALB                 11.47            중간             중간  \n",
       "DZA                 14.89            높음          매우 높음  \n",
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 42,
   "id": "2bbaae02-786c-412d-b53e-abfb8b577da5",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 51,
   "id": "82b0d328-17af-4465-aaac-74a2db1836b5",
   "metadata": {},
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       "            lastdate location  total_cases  total_deaths  total_cases_pm  \\\n",
       "iso_code                                                                   \n",
       "YEM       2020-06-01    Yemen          323            80           10.83   \n",
       "\n",
       "          total_deaths_pm    population  pop_density  median_age  \\\n",
       "iso_code                                                           \n",
       "YEM                  2.68 29,825,968.00        53.51       20.30   \n",
       "\n",
       "          gdp_per_capita  hosp_beds  \n",
       "iso_code                             \n",
       "YEM             1,479.15       0.70  "
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 67,
   "id": "16afc9a6-d1c4-4794-884c-e1ce3876ad09",
   "metadata": {},
   "outputs": [],
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 68,
   "id": "34aaa1f9-61db-460c-89da-10f1f5c5f161",
   "metadata": {},
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       ...
       "iso_code                                                         \n",
       "CAF        Central African Republic         1011             2   \n",
       "QAT                           Qatar        56910            38   \n",
       "SGP                       Singapore        34884            23   \n",
       "SXM       Sint Maarten (Dutch part)           77            15   \n",
       "YEM                           Yemen          323            80   \n",
       "\n",
       "          total_cases_pm  total_deaths_pm total_cases_q total_deaths_q  \\\n",
       "iso_code                                                                 \n",
       "CAF               209.33             0.41            중간          매우 낮음   \n",
       "QAT            19,753.15            13.19         매우 높음             중간   \n",
       "SGP             5,962.73             3.93         매우 높음             중간   \n",
       "SXM             1,795.62           349.80         매우 낮음             중간   \n",
       "YEM                10.83             2.68            낮음             높음   \n",
       "\n",
       "          total_cases_i  total_deaths_i  diff_abs  \n",
       "iso_code                                           \n",
       "CAF                   3               1         2  \n",
       "QAT                   5               3         2  \n",
       "SGP                   5               3         2  \n",
  ...
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "78505aa4-5538-41aa-9897-c4b1df9391d6",
   "metadata": {},
   "outputs": [],
   "source": []
  }
